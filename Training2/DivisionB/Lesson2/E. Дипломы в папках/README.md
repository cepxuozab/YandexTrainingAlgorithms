...
В первой строке входного файла записано целое число N (1<= N <= 100) - количество папок. Во второй строке записаны N целых чисел a1....aN (1<= ai <= 100) - количество дипломов в каждой из папок.
